...
public class ServletPm_categoryDaoImp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map map = new HashMap();
        i = (Integer) request.getSession().getAttribute("ServletPm_categoryDaoImp");
        if ("".equals(i) | i == null) {
            i = 0;
        }
        ...
        for (Pm_category li : list) {
            out.print(li.getPmPicSmallUrl());
        }
        request.getSession().setAttribute("ServletPm_categoryDaoImp", i);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (TIME.equals(xuanze)) {
            Integer integer = (Integer) request.getSession().getAttribute("ServletPm_categoryDaoImp");
