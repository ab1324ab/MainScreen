...
public class ServletPm_content_picsDaoImp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map map = new HashMap();
        i = (Integer) request.getSession().getAttribute("ServletPm_content_picsDaoImp");
        if ("".equals(i) | i == null) {
            i = 0;
        }
        ...
        for (Pm_content_pics li : list) {
            out.print(li.getPmPicUrl());
        }
        request.getSession().setAttribute("ServletPm_content_picsDaoImp", i);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (TIME.equals(xuanze)) {
            Integer integer = (Integer) request.getSession().getAttribute("ServletPm_content_picsDaoImp");
