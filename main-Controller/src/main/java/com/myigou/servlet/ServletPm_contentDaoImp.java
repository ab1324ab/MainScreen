...
public class ServletPm_contentDaoImp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Map map = new HashMap();
        i = (Integer) request.getSession().getAttribute("ServletPm_contentDaoImp");
        if ("".equals(i) | i == null) {
            i = 0;
        }
        ...
        request.getSession().setAttribute("ServletPm_contentDaoImp", i);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (TIME.equals(xuanze)) {
            Integer integer = (Integer) request.getSession().getAttribute("ServletPm_contentDaoImp");
